...
class MainMenuState extends MusicBeatState
{
	...
	public static var fnzrealityversion:String = '0.1 [DEV BUILD]';
	...
	override function create()
	{
		...
		for (i in 0...optionShit.length)
		{
			...
			menuItem.ID = i;
			menuItem.x = 200; //this basically moves the menu to the side
	...
	char.animation.addByPrefix('idleA', 'BF idle dance0000', 24, true);//on 'idle normal' change it to your xml one
