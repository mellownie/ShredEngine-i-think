...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Just like the title :D",	"Play on a Friday... Night.",						'friday_night_play',	 true],
		...
		["Shredbois Average",  				"Get an 88% accuracy in Shredboi's Week",               'shrednerdemoji'			false],
		["Nice",					"Get 420 or 69 misses on any song",                      'GET_IT_CUS_THE_JOKE_IS_P',		false]
		// almost made an oopsie lol
	];
